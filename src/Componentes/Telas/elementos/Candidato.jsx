...
export default function Candidato(props) {
    ...
    function aumentarCurtidas(candidato) {
    ...
    function aumentarDescurtidas(candidato) {
        props.setListaCandidatos(props.listaCandidatos.map((item) =>
            item.id === candidato.id
                ? { ...item, descurtidas: (item.descurtidas + 1) }
                : item
        ))
    }

    function detalharCandidato(candidato){
        props.setCandidatoSel(candidato);
    ...
    return (
        <Card style={{ width: '18rem' }}>
            ...
            <Card.Body>
                ...
                <Button onClick={() => { aumentarCurtidas(props.candidato) }} variant="primary"> {//Curtir
                }
                ...
                <Button onClick={() => { aumentarDescurtidas(props.candidato) }} variant="primary"> {//Não Curtir
                }
                ...
                <Button onClick={() => { detalharCandidato(props.candidato) }} className="mt-1" variant="success">Conheça minhas propostas</Button>
            </Card.Body>
        </Card>
    );
}